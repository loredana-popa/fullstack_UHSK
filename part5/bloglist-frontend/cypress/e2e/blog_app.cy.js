  ...
  describe("When logged in", function () {
    ...
    describe("and some blogs exist", function () {
      ...
      it("a user can see the details of a blog", function () {
        cy.contains("First blog Loredana").contains("view details").click();

        cy.contains("First blog Loredana")
          .parent()
          .should("contain", "http://www.firstblog.com")
      ...
      it("a user can like a blog", function () {
        cy.contains("Second blog Loredana").contains("view details").click();

        cy.contains("Second blog Loredana").parent().find(".like-btn").click();
      ...
      it("the user who created a blog can delete it", function () {
        cy.contains("Third blog Loredana").contains("view details").click();

        cy.contains("Third blog Loredana").parent().find(".remove-btn").click();
